    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf_patient', models.CharField(max_length=100, unique=True, verbose_name='CPF')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_type', models.CharField(choices=[('CELL', 'CELL'), ('RESIDENCIAL', 'RESIDENCIAL'), ('COMERCIAL', 'COMERCIAL'), ('FAX', 'FAX')], default='CELL', max_length=11, verbose_name='Tipo de telefone')),
                ('Patient_idPatient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='patient.Patient', verbose_name='Paciente')),
            ],
            options={
