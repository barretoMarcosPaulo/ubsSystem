...
class Patient(AuditModel):
    ...
    Marital_State_idMarital_State = models.ForeignKey(
        MaritalState, verbose_name="Estado Conjugal", null=True, on_delete=models.SET_NULL
    )
    Medical_Insurance_idMedical_insurance = models.ForeignKey(
        MedicalInsurance, verbose_name="Convênio", null=True, on_delete=models.SET_NULL
    )
    ...
    Type_Logradouro_idLogradouro = models.ForeignKey(
