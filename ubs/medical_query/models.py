...
from ubs.accounts.models import Doctor, User
...
class Query(AuditModel):
    ...
    previous_pathological_history = models.TextField("Historia Patologia Pregressa", max_length=400, blank=False, null=False)
    family_history = models.TextField("História Familiar", max_length=400, blank=False, null=False)
    physiological_personal_antecedents = models.TextField(
        "Antecedentes Pessoais Fisiológicas", max_length=400, blank=False, null=False
    )
    summary = models.TextField("Lista de problemas", max_length=400, blank=False, null=False)
    ...
    PhisicalExam_idPhisicalExam = models.ForeignKey(
        PhisicalExam, verbose_name="Exame Físico", blank=True, null=True, on_delete=models.SET_NULL
    )  # OBS
    ...
    responsible_academics = models.TextField("Acadêmicos Responsáveis", max_length=400, blank=True, null=True)
    staff_CRM = models.TextField("Staff + CRM", max_length=200, blank=True, null=True)
    specific_physical_exam = models.TextField("Exame físico específico", max_length=400, blank=True, null=True)
    identification = models.TextField("Identificação", max_length=400, blank=True, null=True)
    ...
    def get_type_query(self):
        query_type = {1: "Consulta", 2: "Retorno"}
