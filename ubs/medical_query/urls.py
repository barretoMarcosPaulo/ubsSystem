...
urlpatterns = [
    ...
    path("historico-consultas/todas", views.ListAllQuerysHistory.as_view(), name="list_query_all_history"),
    ...
    path(
        "exames/autocomplete",
        views.ExamRequestAutocomplete.as_view(create_field="desc_exam", model=ExamRequest),
        name="examRequest_autocomplete",
    ),
