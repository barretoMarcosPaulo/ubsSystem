    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_user', models.IntegerField(blank=True, choices=[('1', 'Admin'), ('2', 'Médico(a)'), ('3', 'Atendente')], null=True, verbose_name='Tipo de usuário')),
                ('status', models.IntegerField(blank=True, choices=[('1', 'Ativo'), ('2', 'Inativo')], null=True, verbose_name='Status do usuário')),
